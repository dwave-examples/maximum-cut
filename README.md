...
different subsets, and so we assign a 1 for the edge_score column in this case and a 0
otherwise.
...
calculate the edge_score column in our table.  Now for our entire graph, our objective
